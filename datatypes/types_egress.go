...
const (
	EgressClientTriggerOpcode = 0x3AC // Updated for 6.0

	EgressChatZoneOpcode = 0x1CC // Updated for 6.0

	EgressMovementOpcode         = 0x346 // Updated for 6.0
	EgressInstanceMovementOpcode = 0x163 // Updated for 6.0
