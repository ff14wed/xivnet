...
const (
	EgressClientTriggerOpcode = 0x2AB // Updated for 6.18

	EgressChatZoneOpcode = 0xA1 // Updated for 6.18

	EgressMovementOpcode         = 0x375 // Updated for 6.18
	EgressInstanceMovementOpcode = 0x355 // Updated for 6.18
