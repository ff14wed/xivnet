...
const (
	EgressClientTriggerOpcode = 0x28E // Updated for 6.1

	EgressChatZoneOpcode = 0x251 // Updated for 6.1

	EgressMovementOpcode         = 0x3E7 // Updated for 6.1
	EgressInstanceMovementOpcode = 0x225 // Updated for 6.1
