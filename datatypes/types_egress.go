...
const (
	EgressClientTriggerOpcode = 0x2C4 // Updated for 5.4a

	EgressChatZoneOpcode = 0x295 // Updated for 5.4a

	EgressMovementOpcode         = 0x23C // Updated for 5.4a
	EgressInstanceMovementOpcode = 0x226 // Updated for 5.4a
