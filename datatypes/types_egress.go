...
const (
	EgressClientTriggerOpcode = 0xE7 // Updated for 6.05

	EgressChatZoneOpcode = 0x276 // Updated for 6.05

	EgressMovementOpcode         = 0x21B // Updated for 6.05
	EgressInstanceMovementOpcode = 0xA3  // Updated for 6.05
