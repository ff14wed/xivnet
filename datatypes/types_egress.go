...
const (
	EgressClientTriggerOpcode = 0x2F1 // Updated for 6.08

	EgressChatZoneOpcode = 0x1C8 // Updated for 6.08

	EgressMovementOpcode         = 0x147 // Updated for 6.08
	EgressInstanceMovementOpcode = 0x209 // Updated for 6.08
