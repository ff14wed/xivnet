...
const (
	EgressClientTriggerOpcode = 0x34F // Updated for 5.45

	EgressChatZoneOpcode = 0x2F2 // Updated for 5.45

	EgressMovementOpcode         = 0x1B3 // Updated for 5.45
	EgressInstanceMovementOpcode = 0x338 // Updated for 5.45
