...
const (
	EgressClientTriggerOpcode = 0x165 // Updated for 6.31

	EgressChatZoneOpcode = 0x206 // Updated for 6.31

	EgressMovementOpcode         = 0xEE // Updated for 6.31
	EgressInstanceMovementOpcode = 0xE8 // Updated for 6.31
