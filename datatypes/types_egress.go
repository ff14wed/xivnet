...
const (
	EgressClientTriggerOpcode = 0x65 // Updated for 5.41

	EgressChatZoneOpcode = 0x11B // Updated for 5.41

	EgressMovementOpcode         = 0x109 // Updated for 5.41
	EgressInstanceMovementOpcode = 0x2D9 // Updated for 5.41
