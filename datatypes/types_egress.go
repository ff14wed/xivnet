...
const (
	EgressClientTriggerOpcode = 0x283 // Updated for 6.11

	EgressChatZoneOpcode = 0x133 // Updated for 6.11

	EgressMovementOpcode         = 0x187 // Updated for 6.11
	EgressInstanceMovementOpcode = 0x31E // Updated for 6.11
