...
const (
	EgressClientTriggerOpcode = 0x146 // Updated for 5.45a

	EgressChatZoneOpcode = 0xA4 // Updated for 5.45a

	EgressMovementOpcode         = 0x31A // Updated for 5.45a
	EgressInstanceMovementOpcode = 0x34E // Updated for 5.45a
