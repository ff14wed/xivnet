...
const (
	EgressClientTriggerOpcode = 0x174 // Updated for 6.30h

	EgressChatZoneOpcode = 0x2C6 // Updated for 6.30h

	EgressMovementOpcode         = 0x10F // Updated for 6.30h
	EgressInstanceMovementOpcode = 0xDB  // Updated for 6.30h
