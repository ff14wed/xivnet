...
const (
	EgressClientTriggerOpcode = 0x94 // Updated for 6.21

	EgressChatZoneOpcode = 0x248 // Updated for 6.21

	EgressMovementOpcode         = 0x34C // Updated for 6.21
	EgressInstanceMovementOpcode = 0x105 // Updated for 6.21
