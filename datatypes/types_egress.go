...
const (
	EgressClientTriggerOpcode = 0x1A0 // Updated for 5.5

	EgressChatZoneOpcode = 0x3E5 // Updated for 5.5

	EgressMovementOpcode         = 0x8C  // Updated for 5.5
	EgressInstanceMovementOpcode = 0x3AE // Updated for 5.5
