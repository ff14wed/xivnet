...
const (
	EgressClientTriggerOpcode = 0x74 // Updated for 5.4

	EgressChatZoneOpcode = 0x166 // Updated for 5.4

	EgressMovementOpcode         = 0x165 // Updated for 5.4
	EgressInstanceMovementOpcode = 0x384 // Updated for 5.4
