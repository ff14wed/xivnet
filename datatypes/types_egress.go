...
const (
	EgressClientTriggerOpcode = 0x337 // Updated for 5.55a

	EgressChatZoneOpcode = 0x1B8 // Updated for 5.55a

	EgressMovementOpcode         = 0x24B // Updated for 5.55a
	EgressInstanceMovementOpcode = 0x9D  // Updated for 5.55a
